...
/***/ function(module, exports, __webpack_require__) {
	...
	var onPageLoad = function onPageLoad() {
	  api.getAllPrints().done(ui.successPrints).fail(ui.failure);
	};

	//show a single prints
	var onShowPrint = function onShowPrint(id) {
	  api.showPrint(id).done(ui.successPrint).fail(ui.failure);
	};
	...
	var uploadPrints = function uploadPrints() {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllPrints = function getAllPrints() {
	  return $.ajax({
	    url: app.api + '/prints/',
	    method: 'GET'
	  });
	...
	var showPrint = function showPrint(id) {
	  return $.ajax({
	...
	// delete prints
	var deletePrint = function deletePrint(success, failure, id) {
	  $.ajax({
	    url: app.api + '/prints/' + id,
	    method: 'DELETE',
	    headers: {
	...
	// update prints
	var updatePrint = function updatePrint(success, failure, data, id) {
	  $.ajax({
	    method: "PATCH",
	    url: app.api + '/prints/' + id,
	    data: data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayUploads = function displayUploads(prints) {
	...
	var successPrints = function successPrints(prints) {
	  $('#prints').empty();
	  var displayAllPrints = __webpack_require__(30);
	  $('#prints').append(displayAllPrints(prints));
	};

	// show one print in modal, handlebars
	var successPrint = function successPrint(print) {
	  var onePrint = __webpack_require__(31);
	  $('#item').modal('show');
	  $('#item-add').empty().append(onePrint(print));
	};

	// delete
	var deletePrintSuccess = function deletePrintSuccess(data) {
	  console.log(data);
	  displayUploads();
	...
	// update
	var updatePrintSuccess = function updatePrintSuccess(data) {
	  console.log(data);
	...
	module.exports = {
	  ...
	  successPrints: successPrints,
	  uploadSuccess: uploadSuccess,
	  showPicturesSuccess: showPicturesSuccess,
	  deletePrintSuccess: deletePrintSuccess,
	  updatePrintSuccess: updatePrintSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.prints : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	  ...
	  return "\n      <div class=\"content\">\n        <img width=\"40%\" src=\""
	    ...
	    + "</h5>\n\n        <button type=\"button\" class=\"btn btn-warning delete-print\" data-print-id=\""
	    + alias1(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#delete-print-modal\">Delete</button>\n        </div>\n        <br>\n        <button type=\"button\" class=\"btn btn-warning update-print\" data-print-id=\""
	    + alias1(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#update-print-modal\">Update</button>\n        </div>\n        <br>\n        <br>\n        <hr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n\n <div id=\"print\" data-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + " class=\"col-md-4 img\" data-toggle=\"modal\" data-target=\"#item\" height=\"260px\">\n   <img  class=\"print-images\" src=\""
	    + alias4(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
	    + "\"  height=\"400\" width=\"100%\" />\n   <h5 class=\"print-name\">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h5>\n   <h5 class=\"print-price\">$"
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + "</h5>\n </div>\n\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "\n <div id=\"hero\" class=\"col-md-4 hero-feature\" data-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + " data-toggle=\"modal\" data-target=\"#item\" >\n   <div class=\"thumbnail\" >\n       <img id=\"first-page\"  src=\""
	    + alias4(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
	    + "\" alt=\"\">\n       <div class=\"caption\">\n           <h3>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h3>\n           <h4>$"
	  ...
	  return "<!-- "
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.prints : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + " -->\n\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.prints : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"single-print\">\n  <img src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.url : stack1), depth0))
	    + " width=\"300\">\n  <br>\n  <br>\n  <p class=\"price\"><b>PRICE:</b> $"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.price : stack1), depth0))
	    + " </p></b>\n  <p class=\"name\"><b>NAME:</b> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.name : stack1), depth0))
	    + " </p>\n  <p><b>DESCRIPTION:</b> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.description : stack1), depth0))
	    + " <p>\n  <form id=\"form\">\n    <fieldset>\n      <p><b>QUANTITY:</b> <input type=\"number\" min=\"1\" placeholder=\"1\"></p>\n      <input type=\"text\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\">\n      <input type=\"number\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1.price : stack1), depth0))
	    + "\">\n      <input type=\"text\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.print : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\">\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getOrderSuccess = function getOrderSuccess(data) {
	  ...
	  var previousOrders = "<table class = 'order-table'> <tr> <th>Date Purchased</th> <th>Print</th> <th>Price</th> <th>Quantity</th> <th>Total</th> </tr>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b4472aa326012fc2b2430ed2281683d0.jpg";
